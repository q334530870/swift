...
//        return true
        ...
        if showIntroduction == nil{
            ...
            let coverImageNames = ["","","",""]
            let backgroundImageNames = ["tutu1.JPG","tutu2.JPG", "tutu3.JPG","tutu4.JPG"]
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "net.papayachina.weizhudoubiyu" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("weizhudoubiyu", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("weizhudoubiyu.sqlite")
