            ...
            if destination == nil{
                for child in (segue.destinationViewController.childViewControllers){
                    if let info = child as? InfoViewController{
                        info.segue = "buySegue"
                        info.content = "尊敬的各位用户，首先感谢大家对京西贷的关注和支持！\r京西贷团队是一支优秀的、年轻的、充满热情的一支队伍。经过3年的沉淀和积累，1年的精心策划，6个月的研发。京西贷在P2P网络借贷平台迅速发展的今天正式成立并面向大家了！\r京西贷是基于目前中国民间资本发展现状应运而生的，它是一个新的阳光化产业，同时借助于网络高新技术的支持，京西贷专注网络金融服务领域，力求为民间资本创造一个安全、高效、公正的流通互动平台，并引入多家第三方担保机构和第三方支付平台，为投资人做好正确的引导和投资保障。\r京西贷为资金需求者提供了一条新的融资渠道，为投资者拓宽了投资渠道。激活了民间处于低使用率状态的资金，让它们更好的服务于广大需求者。京西贷平台完善的审核制度、监管制度、保障制度将为我们未来的公信度建设打下坚实的基础，为未来的整体发展做好准备。\r我们坚信，在我国社会信用体系、网络技术、服务水平不断完善和提高的过程中，京西贷团队将不惜一切努力做到最好，用服务赢得口碑，用态度实现承诺，用实力证明能力，打造出中国最诚信最可靠的P2P网络借贷平台。"
                    }
                }
            }
        }
